  ...
  const  onReaction =  () => {
    setInit(true)
     if((reaction == {} || reaction == undefined ) && init == false) {
      ...
      else setReaction_state(reaction_state==true?false:true)
    }
    ...
    return (
        ...
        <Modal isVisible={comment_state} 
              ...
              //  animationInTiming={300}
               ...
               style={{ justifyContent:'flex-start',  marginTop:100, marginBottom:50,padding:0,  borderRadius:20,backgroundColor:'#fff', width:'90%', }}
        >
