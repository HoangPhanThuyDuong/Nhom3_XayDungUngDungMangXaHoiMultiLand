...
export default Comments = ({navigation,dataPost}) => {
   ...
   const GetOptions = () => {
    return (
      <SafeAreaView style={{flexDirection:'column',  justifyContent:'center'}}>
        <Modal style={{flexDirection:'column', marginLeft:0, justifyContent:'flex-start',height:100,width:'100%', marginTop:600, backgroundColor:'#fff'}}
  ...
  return (
        <View style={{flexDirection:'column',borderRadius:25,height:'100%', position:'relative'}}>  
                <FlatList   style={{ backgroundColor:'#fff',marginBottom:5,}}
                data={comments}
                horizontal={false}
                renderItem={({item}) => (
            ...
            <View  style={{...textInput_style,paddingLeft:0,backgroundColor:'#eee',position:'absolute',bottom:0,left:0,right:0,}}  >
                <TextInput 
                ...
                <TouchableOpacity style={{ alignItems:'center',margin:0, paddingLeft:20, paddingRight:20, paddingTop:10, paddingBottom:10 ,backgroundColor:'#00f' }} onPress={PostComment}>
